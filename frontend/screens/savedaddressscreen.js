...
//     return <IconComponent name={iconConfig.name} size={24} color={iconConfig.color} />;
//   };
...
//     <MaterialIcons name="home" size={18} color="#184080" />
...
//   <View style={styles.row}>
//     <MaterialIcons name="info-outline" size={18} color="#184080" />
...
//             {type === 'edit' && (
//               <MaterialIcons name="edit" size={50} color="#ED7117" />
//             )}
//             {type === 'delete' && (
//               <MaterialIcons name="warning" size={50} color="#EF4444" />
//             )}
//             {type === 'success' && (
...
//             {/* Removed icons from text input fields */}
...
//             <View style={[styles.modernInputContainer, { height: 100 }]}>
//               <TextInput
//                 style={[styles.modernInput, { textAlignVertical: 'top', height: 80 }]}
