...
from models import  AccountDeactivation, ActivityLog, City, DocumentType, FeedbackType, LiveLocation, PromotionRedemption, Ride, RideFeedback, State, User, OTPVerification, UserFeedback, UserStatus, SavedAddress, ShareActivity, UserType, Vehicle,EmergencyContact,Promotion
